<template>
    <div>
        <br>
        <label>Fecha Inicio
            <input type="date" v-model="params.pfecha_ini" @change="change()" class="form-control"/>
        </label>
        <label>Fecha Final
            <input type="date" v-model="params.pfecha_fin" @change="change()" class="form-control"/>
        </label>
        <label>User
            <select v-model="params.puser_id" @change="change()" class="form-control">
        ...
        <a href="" class="btn btn-success"><i class="glyphicon glyphicon-export"></i> Excel</a>
        <a href="" class="btn btn-success"><i class="glyphicon glyphicon-export"></i> Csv</a>
        <br>
        <br>
